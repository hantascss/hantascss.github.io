...
<div class="container">
    <section class="header">
      <h2 class="title">Hantas</h2>
      <p>一款基于CSS逻辑属性构建的下一代CSS矿监。</p>
      <a class="button button-primary" href="">下载试用</a>

      <div class="row">
        <div class="four columns">
          <img class="value-img" src="/assets/images/feather.svg"> Light as a feather at ~550 lines &amp; built with mobile in mind.
        </div>
        <div class="four columns value-prop">
          <img class="value-img" src="/assets/images/pens.svg"> Styles designed to be a starting point, not a UI framework.
        </div>
        <div class="four columns value-prop">
          <img class="value-img" src="/assets/images/watch.svg"> Quick to start with zero compiling or installing necessary.
        </div>
      </div>
    </section>
